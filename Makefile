...
generate: manifests $(CONTROLLER_GEN) $(CONVERSION_GEN) ## Generate code
	...
	$(CONVERSION_GEN) \
    		--input-dirs=./apis/microsoft.network/v20191101,./apis/microsoft.resources/v20191001,./apis/microsoft.compute/v20191201,./apis/microsoft.containerservice/v20191101,./apis/microsoft.resources/v20150101 \
